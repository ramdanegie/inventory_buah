...
import { DaftarClosingPembayaranComponent } from './page/modules/transaksi/daftar-closing-pembayaran/daftar-closing-pembayaran.component';
...
@NgModule({
    ...
    declarations: [
        ...
        DaftarClosingPembayaranComponent,
